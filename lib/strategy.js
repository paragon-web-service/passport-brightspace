...
function Strategy(options, verify) {
  ...
  this._userProfileURL = options.userProfileURL || `${options.host}/d2l/api/lp/1.26/users/whoami`;
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  this._oauth2.get(this._userProfileURL, accessToken, (err, body, res) => {
    ...
    this._oauth2.get(this._userProfileURL.replace('whoami', whoami.Identifier), accessToken, (err, body, res) => {
      var json;
      ...
      var profile = Profile.parse({ ...whoami, ...json });
